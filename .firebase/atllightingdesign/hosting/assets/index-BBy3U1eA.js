const __vite__mapDeps = (
  i,
  m = __vite__mapDeps,
  d = m.f || (m.f = ['assets/ContactView-DiDemtka.js', 'assets/ContactView-B_SY1GJM.css'])
) => i.map((i) => d[i])
;(function () {
  ...
  if ((Fs(), t === 'clear')) o.forEach(c)
    ...
    if (l && n === 'length') {
      ...
      switch (((n !== void 0 || o.has(void 0)) && c(o.get(n)), h && c(o.get(cn)), t)) {
        case 'add':
          l ? h && c(o.get('length')) : (c(o.get(At)), jt(e) && c(o.get(ps)))
          break
        case 'delete':
          l || (c(o.get(At)), jt(e) && c(o.get(ps)))
          break
        case 'set':
          jt(e) && c(o.get(At))
          break
...
function es(e, t, n) {
  ...
  _e(s, 'iterate', cn)
  const r = s[t](...n)
  return (r === -1 || r === !1) && Vs(n[0]) ? ((n[0] = z(n[0])), s[t](...n)) : r
}
function qt(e, t, n = []) {
  yt(), Fs()
...
class mi extends gi {
  ...
  set(t, n, s, r) {
    ...
    if (!this._isShallow) {
      const l = Tt(i)
      if ((!De(s) && !Tt(s) && ((i = z(i)), (s = z(s))), !j(t) && xe(i) && !xe(s)))
        return l ? !1 : ((i.value = s), !0)
    }
    const o = j(t) && $s(n) ? Number(n) < t.length : Y(t, n),
      c = Reflect.set(t, n, s, xe(t) ? t : r)
    return t === z(r) && (o ? mt(s, i) && tt(t, 'set', n, s) : tt(t, 'add', n, s)), c
  }
  deleteProperty(t, n) {
    const s = Y(t, n)
    t[n]
  ...
  ownKeys(t) {
    return _e(t, 'iterate', j(t) ? 'length' : At), Reflect.ownKeys(t)
  }
}
class zo extends gi {
  constructor(t = !1) {
  ...
  const n = {
    ...
    forEach(r, i) {
      const o = this,
        ...
        l = z(c),
        h = t ? gs : e ? ms : ye
      return !e && _e(l, 'iterate', At), c.forEach((f, d) => r.call(i, h(f), h(d), o))
    }
  }
  return (
    de(
        ...
        : {
            ...
            delete(r) {
              const i = z(this),
                { has: o, get: c } = bn(i)
              let l = o.call(i, r)
              l || ((r = z(r)), (l = o.call(i, r))), c && c.call(i, r)
              const h = i.delete(r)
...
function rl(e) {
  return e.__v_skip || !Object.isExtensible(e) ? 0 : sl(Ao(e))
}
function kn(e) {
  return Tt(e) ? e : Bs(e, !1, Go, Zo, vi)
}
function bi(e) {
  return Bs(e, !1, Yo, el, _i)
}
function xi(e) {
  return Bs(e, !0, Qo, tl, yi)
}
...
function il(e) {
  return !Y(e, '__v_skip') && Object.isExtensible(e) && ni(e, '__v_skip', !0), e
}
...
function dl(e, t, n = se) {
  ...
  let I = A ? new Array(e.length).fill(wn) : wn
  const N = (O) => {
    if (!(!(f.flags & 1) || (!f.dirty && !O)))
      if (t) {
        const U = f.run()
        if (r || S || (A ? U.some((ne, ee) => mt(ne, I[ee])) : mt(U, I))) {
          p && p()
          const ne = Ct
          Ct = f
          try {
            const ee = [U, I === wn ? void 0 : A && I[0] === wn ? [] : I, g]
            l ? l(t, 3, ee) : t(...ee), (I = U)
          } finally {
            Ct = ne
          }
...
function Ai(e) {
  try {
    ...
    ;(ze = -1), (Ee.length = 0), Pi(), (On = null), (Ee.length || kt.length) && Ai()
  }
}
let ge = null,
  Ti = null
...
function vs(e, t, n, s, r) {
  const {
    ...
    ee = (V, q) => {
      const re = q[1]
      ne(V, q), j(V) ? V.every((L) => L.length <= 1) && re() : V.length <= 1 && re()
    },
    me = {
      mode: o,
      persisted: c,
      beforeEnter(V) {
        ...
        V[dt] && V[dt](!0)
        const re = U[O]
        re && Rt(e, re) && re.el[dt] && re.el[dt](), ne(q, [V])
      },
      enter(V) {
        let q = h,
          re = f,
      ...
      leave(V, q) {
        ...
        if ((V[En] && V[En](!0), n.isUnmounting)) return q()
        ne(p, [V])
        let L = !1
        const G = (V[dt] = (he) => {
          L ||
...
function _s(e, t, n, s, r = !1) {
  if (j(e)) {
    e.forEach((S, A) => _s(S, t && (j(t) ? t[A] : t), n, s, r))
    return
  }
  if (Bt(s) && !r) return
  ...
  if (
    ...
    if (S || A) {
      const H = () => {
        ...
        } else S ? ((f[l] = o), g(l) && (d[l] = o)) : A && ((l.value = o), e.k && (f[e.k] = o))
      }
      o ? ((H.id = -1), Oe(H, n)) : H()
    }
  }
    ...
    get({ _: e }, t) {
      ...
      if (t[0] !== '$') {
        ...
        if (g !== void 0)
          ...
          if (r !== se && Y(r, t)) return (o[t] = 2), r[t]
          if ((h = e.propsOptions[0]) && Y(h, t)) return (o[t] = 3), i[t]
          if (n !== se && Y(n, t)) return (o[t] = 4), n[t]
          xs && (o[t] = 0)
        }
      }
      const f = nn[t]
...
function Ml(e) {
  ...
  if (((xs = !0), i))
    for (const te in i) {
      const Q = i[te],
        Je = B(Q) ? Q.bind(n, n) : B(Q.get) ? Q.get.bind(n, n) : Qe,
        ot = !B(Q) && B(Q.set) ? Q.set.bind(n) : Qe,
        Ke = Fe({ get: Je, set: ot })
  ...
  f && lr(f, e, 'c')
  function fe(te, Q) {
    j(Q) ? Q.forEach((Je) => te(Je.bind(n))) : Q && te(Q.bind(n))
  }
  if (
    (fe(Sl, d),
    fe(Ks, p),
    ...
    if (q.length) {
      ...
      q.forEach((Q) => {
        Object.defineProperty(te, Q, { get: () => n[Q], set: (Je) => (n[Q] = Je) })
      })
...
function Bl(e, t, n, s) {
  ...
  if ((s || o > 0) && !(o & 16)) {
    ...
    let f
    for (const d in c)
      (!t || (!Y(t, d) && ((f = Ot(d)) === d || !Y(t, f)))) &&
        (l
          ? n && (n[d] !== void 0 || n[f] !== void 0) && (r[d] = Es(l, c, d, void 0, e, !0))
          : delete r[d])
    if (i !== c) for (const d in i) (!t || !Y(t, d)) && (delete i[d], (h = !0))
  }
  h && tt(e.attrs, 'set', '')
}
function zi(e, t, n, s) {
  ...
  if (j(i))
    ...
    for (const f in i) {
      ...
      if (fr(d)) {
        ...
        else A = B(S) && S.name === 'Boolean'
        ;(g[0] = A), (g[1] = H), (A || Y(g, 'default')) && c.push(d)
      }
    }
  const h = [o, c]
...
const Qi = (e) => e[0] === '_' || e === '$stable',
  ...
  Kl = (e, t, n) => {
    ...
    if (e.vnode.shapeFlag & 32) {
      const r = t._
      r ? (Xi(s, t, n), n && ni(s, '_', r, !0)) : Yi(t, s)
    } else t && Ji(e, t)
  },
  Wl = (e, t, n) => {
    ...
    if (s.shapeFlag & 32) {
      const c = t._
      c ? (n && c === 1 ? (i = !1) : Xi(r, t, n)) : ((i = !t.$stable), Yi(t, r)), (o = t)
    } else t && (Ji(e, t), (o = { default: 1 }))
    if (i) for (const c in r) !Qi(c) && o[c] == null && delete r[c]
  },
  Oe = ic
function ql(e) {
  return zl(e)
...
function zl(e, t) {
  ...
  const {
    ...
    A = (a, u, m, y = null, v = null, b = null, C = void 0, E = null, w = !!u.dynamicChildren) => {
      if (a === u) return
      ...
      switch (x) {
        ...
        default:
          P & 1
            ...
            : P & 6
              ? G(a, u, m, y, v, b, C, E, w)
              : (P & 64 || P & 128) && x.process(a, u, m, y, v, b, C, E, w, M)
      }
    ...
    ne = (a, u, m, y, v, b, C, E) => {
      ...
      if (
        ...
        P & 8 ? f(w, a.children) : P & 16 && me(a.children, w, null, y, v, ss(a, b), C, E),
    ...
    V = (a, u, m, y, v, b, C) => {
      ...
      if (
        ...
        ((P.innerHTML && F.innerHTML == null) || (P.textContent && F.textContent == null)) &&
          f(E, ''),
        x
          ? q(a.dynamicChildren, x, E, m, y, ss(u, v), b)
          : C || Q(a, u, E, null, m, y, ss(u, v), b, !1),
        w > 0)
      ) {
        if (w & 16) re(E, P, F, m, v)
        else if (
          ...
          for (let ie = 0; ie < K.length; ie++) {
            const X = K[ie],
              Pe = P[X],
              ve = F[X]
            ;(ve !== Pe || X === 'value') && i(E, X, Pe, ve, v, m)
          }
        }
        w & 1 && a.children !== u.children && f(E, u.children)
      } else !C && x == null && re(E, P, F, m, v)
    ...
    L = (a, u, m, y, v, b, C, E, w) => {
      ...
      let { patchFlag: P, dynamicChildren: F, slotScopeIds: k } = u
      k && (E = E ? E.concat(k) : k),
        a == null
          ? (s(x, m, y), s(D, m, y), me(u.children || [], m, D, v, b, C, E, w))
          : P > 0 && P & 64 && F && a.dynamicChildren
            ? (q(a.dynamicChildren, F, m, v, b, C, E),
    ...
    fe = (a, u, m, y, v, b, C) => {
      const E = () => {
        if (a.isMounted) {
          let { next: P, bu: F, u: k, parent: K, vnode: ie } = a
          {
            const Ae = eo(a)
            if (Ae) {
              P && ((P.el = ie.el), te(a, P, C)),
                Ae.asyncDep.then(() => {
                  a.isUnmounted || E()
                })
              return
          ...
          let X = P,
            Pe
          wt(a, !1),
            P ? ((P.el = ie.el), te(a, P, C)) : (P = ie),
            F && Yn(F),
            (Pe = P.props && P.props.onVnodeBeforeUpdate) && qe(Pe, K, P, ie),
            wt(a, !0)
          const ve = rs(a),
            He = a.subTree
          ;(a.subTree = ve),
            A(He, ve, d(He.el), _(He), a, v, b),
            (P.el = ve.el),
            X === null && rc(a, ve.el),
            k && Oe(k, v),
            (Pe = P.props && P.props.onVnodeUpdated) && Oe(() => qe(Pe, K, P, ie), v)
        } else {
          let P
          const { el: F, props: k } = u,
            { bm: K, m: ie, parent: X, root: Pe, type: ve } = a,
            He = Bt(u)
          if (
            (wt(a, !1),
            K && Yn(K),
            !He && (P = k && k.onVnodeBeforeMount) && qe(P, X, u),
            wt(a, !0),
            F && ae)
          ) {
            const Ae = () => {
            ...
            He && ve.__asyncHydrate ? ve.__asyncHydrate(F, a, Ae) : Ae()
          } else {
            Pe.ce && Pe.ce._injectChildStyle(ve)
            const Ae = (a.subTree = rs(a))
            A(null, Ae, m, y, a, v, b), (u.el = Ae.el)
          }
          if ((ie && Oe(ie, v), !He && (P = k && k.onVnodeMounted))) {
            const Ae = u
            Oe(() => qe(P, X, Ae), v)
          }
    ...
    Q = (a, u, m, y, v, b, C, E, w = !1) => {
      ...
      if (F > 0) {
        if (F & 128) {
          ot(x, P, m, y, v, b, C, E, w)
          return
        } else if (F & 256) {
          Je(x, P, m, y, v, b, C, E, w)
          return
        }
      }
      k & 8
        ? (D & 16 && Me(x, v, b), P !== x && f(m, P))
        : D & 16
          ? k & 16
            ? ot(x, P, m, y, v, b, C, E, w)
            : Me(x, v, b, !0)
          : (D & 8 && f(m, ''), k & 16 && me(P, m, y, v, b, C, E, w))
    },
    Je = (a, u, m, y, v, b, C, E, w) => {
      ;(a = a || Dt), (u = u || Dt)
      const x = a.length,
        D = u.length,
        P = Math.min(x, D)
      ...
      for (F = 0; F < P; F++) {
        ...
        A(a[F], k, m, null, v, b, C, E, w)
      }
      x > D ? Me(a, v, b, !0, !1, P) : me(u, m, y, v, b, C, E, w, P)
    },
    ot = (a, u, m, y, v, b, C, E, w) => {
      ...
      for (; x <= P && x <= F; ) {
        ...
        if (Rt(k, K)) A(k, K, m, null, v, b, C, E, w)
        else break
        x++
      }
      for (; x <= P && x <= F; ) {
      ...
      if (x > P) {
        if (x <= F) {
          const k = F + 1,
            K = k < D ? u[k].el : y
          for (; x <= F; ) A(null, (u[x] = w ? ht(u[x]) : Ge(u[x])), m, K, v, b, C, E, w), x++
        }
        ...
        for (x = k; x <= P; x++) {
          ...
          We === void 0
            ...
            : ((Wt[We - K] = x + 1),
              We >= Ae ? (Ae = We) : (He = !0),
              A(Te, u[We], m, null, v, b, C, E, w),
              Pe++)
        }
        const Zs = He ? Ql(Wt) : Dt
        for (X = Zs.length - 1, x = ve - 1; x >= 0; x--) {
          const Te = K + x,
            We = u[Te],
            er = Te + 1 < D ? u[Te + 1].el : y
          Wt[x] === 0
            ? A(null, We, m, er, v, b, C, E, w)
    ...
    Ke = (a, u, m, y, v = null) => {
      ...
      if (C === pe) {
        s(b, u, m)
        for (let P = 0; P < w.length; P++) Ke(w[P], u, m, y)
        s(a.anchor, u, m)
        return
      }
      if (C === Rn) {
  ...
  const R = (a, u, m) => {
      a == null
        ...
        : A(u._vnode || null, a, u, null, null, null, m),
        (u._vnode = a),
        T || ((T = !0), rr(), Pi(), (T = !1))
    },
    M = { p: A, um: Ce, m: Ke, r: It, mt: he, mc: me, pc: Q, pbc: q, n: _, o: e }
  let J, ae
  return { render: R, hydrate: J, createApp: Hl(R, J) }
}
...
function ec(e, t, ...n) {
  ...
  let c,
    l = s[(c = Qn(t))] || s[(c = Qn(vt(t)))]
  !l && i && (l = s[(c = Qn(Ot(t)))]), l && Ve(l, e, 6, r)
  const h = s[c + 'Once']
  if (h) {
...
function Wn(e, t) {
  return !e || !Nn(t)
    ...
    : ((t = t.slice(2).replace(/Once$/, '')),
      Y(e, t[0].toLowerCase() + t.slice(1)) || Y(e, Ot(t)) || Y(e, t))
}
function rs(e) {
  const {
      type: t,
...
function W(e, t = null, n = null, s = 0, r = null, i = e === pe ? 0 : 1, o = !1, c = !1) {
  const l = {
    __v_isVNode: !0,
    __v_skip: !0,
    type: e,
...
function _t(e, t, n = !1, s = !1) {
  const { props: r, ref: i, patchFlag: o, children: c, transition: l } = e,
    ...
    f = {
      ...
      props: h,
      key: h && oo(h),
      ref: t && t.ref ? (n && i ? (j(i) ? i.concat(Pn(t)) : [i, Pn(t)]) : Pn(t)) : i,
      scopeId: e.scopeId,
...
if (vr)
  try {
    Ps = vr.createPolicy('vue', { createHTML: (e) => e })
  } catch {}
const ao = Ps ? (e) => Ps.createHTML(e) : (e) => e,
...
function Rc(e) {
  ...
  const {
    ...
    re = (L) => (G, he) => {
      ...
      Et(je, [G, fe]),
        br(() => {
          St(G, L ? l : i), ct(G, L ? f : c), yr(je) || xr(G, s, A, fe)
        })
    }
  return de(t, {
    onBeforeEnter(L) {
...
function aa(e) {
  return Qs(e).replace(mo, '{').replace(vo, '}').replace(go, '^')
}
function As(e) {
  return Qs(e)
    .replace(po, '%2B')
...
function fa(e) {
  return As(e).replace(na, '%3D')
}
function ua(e) {
  return Qs(e).replace(ho, '%23').replace(sa, '%3F')
}
function da(e) {
...
function Ta(e) {
  e = ya(e)
  const t = Aa(e),
    n = Pa(e, t.state, t.location, t.replace)
  function s(i, o = !0) {
  ...
  for (const h of e) {
    ...
    for (let d = 0; d < h.length; d++) {
      ...
      if (p.type === 0) d || (r += '/'), (r += p.value.replace(La, '\\$&')), (g += 40)
        ...
        const { value: S, repeatable: A, optional: H, regexp: $ } = p
        i.push({ name: S, repeatable: A, optional: H })
        const I = $ || jr
        if (I !== jr) {
          g += 10
          try {
    ...
    for (const p of e) {
      ...
      for (const g of p)
        if (g.type === 0) f += g.value
          ...
          const { value: S, repeatable: A, optional: H } = g,
            $ = S in h ? h[S] : ''
          if (Ue($) && !A)
            throw new Error(
...
function Ha(e, t) {
  ...
  function h(d, p) {
    ...
    if ('name' in d && d.name) {
      ...
      (A = d.path), (g = n.find((N) => N.re.test(A))), g && ((S = g.parse(A)), (H = g.record.name))
    else {
      if (((g = p.name ? s.get(p.name) : n.find((N) => N.re.test(p.path))), !g))
        throw Kt(1, { location: d, currentLocation: p })
      ;(H = g.record.name), (S = Z({}, p.params, d.params)), (A = g.stringify(S))
    }
    const $ = []
    let I = g
    for (; I; ) $.unshift(I.record), (I = I.parent)
    return { name: H, path: A, params: S, matched: $, meta: Va($) }
  }
  e.forEach((d) => i(d))
  function f() {
    ;(n.length = 0), s.clear()
...
function Ur(e) {
  ...
  for (let n in e) {
    ...
    ;(Ue(s) ? s.map((i) => i && As(i)) : [s && As(s)]).forEach((i) => {
...
function Wr(e) {
  const t = Ye(Ys),
    ...
    i = Fe(() => r.value > -1 && Ja(n.params, s.value.params)),
    o = Fe(() => r.value > -1 && r.value === n.matched.length - 1 && _o(n.params, s.value.params))
  function c(l = {}) {
    return Ya(l) ? t[Ne(e.replace) ? 'replace' : 'push'](Ne(e.to)).catch(rn) : Promise.resolve()
  }
        ...
        Cn(
          ...
          ([h, f, d], [p, g, S]) => {
            f &&
              ...
              h && f && (!g || !Ut(f, g) || !p) && (f.enterCallbacks[d] || []).forEach((A) => A(h))
          },
          { flush: 'post' }
        ),
        () => {
...
function Za(e) {
  ...
  function $(_, T) {
    ...
    const ae = ga(s, Z({}, _, { hash: aa(J), path: M.path })),
      a = r.createHref(ae)
    return Z({ fullPath: ae, hash: J, query: s === Ur ? qa(_.query) : _.query || {} }, M, {
      redirectedFrom: void 0,
      href: a
    })
  }
  ...
  function ee(_, T) {
    ...
    if (u)
      return ee(
        Z(I(u), { state: typeof u == 'object' ? Z({}, J, u.state) : J, force: ae, replace: a }),
        T || R
      )
    const m = R
    m.redirectedFrom = T
    ...
    return (
      ...
      (y ? Promise.resolve(y) : q(m, M))
        .catch((v) => (Ze(v) ? (Ze(v, 2) ? v : ot(v)) : Q(v, m, M)))
        .then((v) => {
          if (v) {
            if (Ze(v, 2))
              return ee(
                Z({ replace: a }, I(v.to), {
                  state: typeof v.to == 'object' ? Z({}, J, v.to.state) : J,
                  force: ae
                }),
                T || m
              )
  ...
  function L(_, T, R, M, J) {
    ...
    R &&
      (M || a
        ? r.replace(_.fullPath, Z({ scroll: a && u && u.scroll }, J))
        : r.push(_.fullPath, J)),
      (l.value = _),
      Ke(_, T, R, a),
      ot()
              ...
              Ze(a, 12)
                ...
                : Ze(a, 2)
                  ? (ee(a.to, M)
                      ...
                      .catch(rn),
                    Promise.reject())
                  : (R.delta && r.go(-R.delta, !1), Q(a, M, ae))
            )
            .then((a) => {
              ;(a = a || L(M, ae, !1)),
                a &&
  ...
  function Q(_, T, R) {
    ot(_)
    const M = fe.list()
    return M.length ? M.forEach((J) => J(_, T, R)) : console.error(_), Promise.reject(_)
  }
  function Je() {
    ...
    yn = {
      ...
      install(_) {
        ...
        _.component('RouterLink', Ft),
          ...
          Nt && !It && l.value === at && ((It = !0), O(r.location).catch((J) => {}))
        const R = {}
        for (const J in at) Object.defineProperty(R, J, { get: () => l.value[J], enumerable: !0 })
        _.provide(Ys, T), _.provide(Js, bi(R)), _.provide(Os, l)
        const M = _.unmount
        Lt.add(_),
          (_.unmount = function () {
            Lt.delete(_),
...
const nf = { class: 'flex flex-col min-h-screen' },
    ...
    setup(e) {
      ...
      return (s, r) => (
        ...
        ke('div', nf, [
              ...
              W('nav', of, [
                W('div', lf, [
                  ce(
                    ...
                    {
                      default: st(
                        () => r[0] || (r[0] = [W('img', { alt: 'Vue logo', src: Xc }, null, -1)])
                      ),
                      _: 1
                    }
                  )
          ...
          r[5] ||
            (r[5] = Cs(
              '<footer class="flex flex-col bg-black py-8 mt-auto" data-v-f8da8b1e><div class="mx-[5%]" data-v-f8da8b1e><div class="flex flex-wrap items-start gap-8 relative" data-v-f8da8b1e><div class="w-full h-[2px] bg-white" data-v-f8da8b1e></div><div class="flex-1 text-white ml-5" data-v-f8da8b1e><p class="font-medium text-white" data-v-f8da8b1e>Shanghai, China</p><p class="font-medium text-white" data-v-f8da8b1e>Xi&#39;an, China</p><p class="font-medium text-white" data-v-f8da8b1e>Calgary, Canada</p></div><div class="flex flex-col items-start gap-2 mr-5" data-v-f8da8b1e><div data-v-f8da8b1e><p class="font-medium text-white mb-1" data-v-f8da8b1e>Connect with us:</p><p class="text-white" data-v-f8da8b1e>atl@188.com</p></div><p class="text-white text-sm" data-v-f8da8b1e>© 2024 ATL Lighting Design</p></div></div></div></footer>',
              1
            ))
        ])
      )
  ...
  uf = Xs(ff, [['__scopeId', 'data-v-f8da8b1e']]),
  df = 'modulepreload',
  hf = function (e) {
    return '/' + e
  },
...
function xf(e, t, n, s, r, i) {
  return (
    ...
    ke(
      ...
      null,
      [
        W('div', mf, [ki(e.$slots, 'default', { currentSlide: s.currentSlide })]),
        Pt(' Navigation '),
        s.navEnabled
          ? (Re(),
            ke('div', vf, [
        ...
        ke('main', Tf, [
          r[4] ||
            (r[4] = W(
              ...
              {
                className:
                  'absolute bottom-[30%] right-[10%] z-10 text-white text-4xl font-semibold backdrop-blur-[3px] p-1 rounded-xl shadow-3xl'
              },
          ...
          W('div', Mf, [
            ...
            W('div', $f, [
              W('div', null, [
                r[1] || (r[1] = W('h1', { class: 'text-5xl text-white' }, 'Our Values', -1)),
                W('div', Nf, [
                  (Re(!0),
                  ke(
                    pe,
                    ...
                    ys(
                      ...
                      (i) => (
                        ...
                        ke('div', { key: i.title }, [
                          ...
                          W('img', { src: i.imagelink, class: 'w-full pt-20' }, null, 8, Hf)
                        ])
                      )
                    ),
                    128
  ...
  Bf = Za({
    ...
    routes: [
      { path: '/', name: 'home', component: kf },
      {
        path: '/news',
        name: 'News',
        component: () => Yt(() => import('./NewsView-BCm6AzjG.js'), [])
      },
      {
        path: '/projects',
        name: 'Projects',
        component: () => Yt(() => import('./ProjectsView-BHJZydNa.js'), [])
      },
      {
        path: '/projectpage',
        name: 'Project Page',
        component: () => Yt(() => import('./ProjectPageView-CEw-b4tU.js'), [])
      },
      {
        path: '/awards',
        name: 'Awardss',
        component: () => Yt(() => import('./AwardsView-giAETGcc.js'), [])
      },
      {
        path: '/contact',
        name: 'Contact',
        component: () => Yt(() => import('./ContactView-DiDemtka.js'), __vite__mapDeps([0, 1]))
      }
    ]
  }),
  Co = Qc(uf)
